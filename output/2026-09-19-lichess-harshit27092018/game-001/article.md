...
注目したいのは、f6にポーンを進めた結果、f7が空き、e8–h5の斜めが開いたことです。白には **11.Qh5+** があり、python-chessでも合法なチェックであることを確認しました。参考変化は **11.Qh5+ g6 12.Qf3**。評価は約 **−0.55** です。
...
**19...Bc5** の意味は、ビショップc5・ナイトd4・白クイーンe3が同じ斜めに並ぶことです。次の **...Nf3+** はチェックをかけながら、ビショップがクイーンを狙うディスカバード・アタックになります（**20.Bb4 Nf3+** で合法なチェックであることを確認）。参考変化は **19...Bc5 20.Bb4 Nf3+ 21.Nxf3 Bxe3 22.fxe3 Qc6** です。
...
**今回の学び：** 自分の駒と相手のクイーンが一直線に並んだら、ディスカバード・アタックを探す。勝勢のときは、ポーンを取るより、相手にとって受けにくい脅威を優先する。
...
- **勝勢でも、脅威を保つ手を優先する。** 一直線に並んだ駒は、ディスカバード・アタックのサインです。
